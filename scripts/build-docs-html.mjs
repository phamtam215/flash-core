...
const PAGES = [
  ...
  { src: 'docs/adr/009-csrf-double-submit-co-ky.md', out: 'adr-009-csrf-double-submit-co-ky.html', title: 'ADR-009: CSRF double-submit có ký' },
  { src: 'docs/adr/010-keyset-pagination-thay-offset.md', out: 'adr-010-keyset-pagination-thay-offset.html', title: 'ADR-010: Keyset pagination thay OFFSET' },
  { src: 'docs/adr/011-idempotency-key-lay-db-lam-trong-tai.md', out: 'adr-011-idempotency-key-lay-db-lam-trong-tai.html', title: 'ADR-011: Idempotency-Key lấy DB làm trọng tài' },
  ...
  { src: 'docs/specs/phase8-sale-event.md', out: 'spec-phase-8.html', title: 'Spec Phase 8 — Đợt sale thật' },
  { src: 'docs/specs/phase9-web-hoan-thien.md', out: 'spec-phase-9.html', title: 'Spec Phase 9 — Web hoàn thiện' },
...
const NAV = [
  ...
  ['Spec — hợp đồng từng phase', [
    ...
    ['spec-phase-8.html', 'Phase 8 — Đợt sale (draft)'],
...
const LINK_MAP = new Map([
  ...
  ['009-csrf-double-submit-co-ky.md', 'adr-009-csrf-double-submit-co-ky.html'],
  ['010-keyset-pagination-thay-offset.md', 'adr-010-keyset-pagination-thay-offset.html'],
  ['011-idempotency-key-lay-db-lam-trong-tai.md', 'adr-011-idempotency-key-lay-db-lam-trong-tai.html'],
  ...
  ['phase8-sale-event.md', 'spec-phase-8.html'],
  ['phase9-web-hoan-thien.md', 'spec-phase-9.html'],
