...
- `docs/html/hoc/index.html` — **giáo trình 8 phase** (HTML, mở bằng trình duyệt). Sở hữu *sơ đồ*:
  ...
  sách ý nằm ở `docs/html/hoc/assets/track.js` (nguồn sự thật duy nhất — sửa ý thì sửa ở đó, cả
