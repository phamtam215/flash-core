...
- [x] ~10 ADR — hiện **11** (`docs/adr/001`–`011`). Ba cái cuối ghi lại quyết định đã áp dụng từ lâu mà chưa có ADR: [009 CSRF double-submit có ký](adr/009-csrf-double-submit-co-ky.md), [010 keyset pagination thay OFFSET](adr/010-keyset-pagination-thay-offset.md), [011 Idempotency-Key lấy UNIQUE của DB làm trọng tài](adr/011-idempotency-key-lay-db-lam-trong-tai.md)
